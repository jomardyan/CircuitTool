...
namespace CircuitTool
{
    ...
    public static class ResistorCalculator
    {
        ...
        // Computes safety margin and safe-operating-area flag for a resistor analysis (80% derating rule).
        private static void ApplySafetyMargin(ResistorAnalysis analysis)
        {
            analysis.SafetyMargin = analysis.PowerRating > 0 ?
                (analysis.PowerRating - analysis.Power) / analysis.PowerRating * 100 : 0;
            analysis.WithinSafeOperatingArea = analysis.Power <= analysis.PowerRating * 0.8;
        }
