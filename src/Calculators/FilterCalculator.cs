...
namespace CircuitTool
{
    ...
    public static class FilterCalculator
    {
        ...
        public static double RCLowPassCutoffFrequency(double resistance, double capacitance)
        {
            ...
            return RCCutoffFrequency(resistance, capacitance);
        }
        ...
        public static double RLLowPassCutoffFrequency(double resistance, double inductance)
        {
            ...
            return RLCutoffFrequency(resistance, inductance);
        }
        ...
        // Shared formula: fc = 1 / (2π R C)
        private static double RCCutoffFrequency(double resistance, double capacitance) =>
            1.0 / (2 * Math.PI * resistance * capacitance);

        // Shared formula: fc = R / (2π L)
        private static double RLCutoffFrequency(double resistance, double inductance) =>
