...
namespace CircuitTool
{
    ...
    public static class ACCircuitCalculator
    {
        ...
        public static double PeakToPeak(double peakValue)
        {
            return 2 * peakValue;
        }
        ...
        /// <param name="peakValue">Peak value.</param>
        /// <returns>Peak-to-peak value.</returns>
        [Obsolete("PeakToPeakToPeak is deprecated. Use PeakToPeak instead. This method will be removed in a future version.")]
        public static double PeakToPeakToPeak(double peakValue)
        {
            return PeakToPeak(peakValue);
        }
